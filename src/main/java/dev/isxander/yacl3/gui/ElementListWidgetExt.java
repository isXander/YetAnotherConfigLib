...
//
//    //? if >=1.21.9
//    protected final int headerHeight = 0;
//
//    public ElementListWidgetExt(Minecraft client, int y, int width, int height, boolean smoothScrolling) {
//        //? if >=1.21.4 {
...
//        double mouseX = e.x(); double mouseY = e.y(); int button = e.button();
//    //?} else {
